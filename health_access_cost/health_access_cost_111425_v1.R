...
write.csv(results, "health_access_ascvd_results_111725_v1.csv", row.names = FALSE)
...
# figure 2: access and affordability by race and income among the whole population
...
write.csv(results_race, "health_access_race_results_111725_v1.csv", row.names = FALSE)
write.csv(results_income, "health_access_income_results_111725_v1.csv", row.names = FALSE)
